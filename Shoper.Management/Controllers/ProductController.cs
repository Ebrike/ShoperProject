...
namespace Shoper.Management.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ProductController(IProductService productService, ICategoryService categoryService, IProductImageService productImageService, IProductPriceService productPriceService)
        {
